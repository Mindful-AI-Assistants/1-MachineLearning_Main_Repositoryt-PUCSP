...
|------|------------|-------------------------------------------------------------------------------|------------------------------------------|
| 1    | 19 Feb    | Introduction to Machine Learning                                              | `/week-1/intro-ml.ipynb`  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)        |
| 2    | 26 Feb    | What are neural networks? Intro to Perceptron. Basic shallow NN model.        | `/week-2/perceptron/`  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)           |
| 3    | 05 Mar    | Supervised training: Loss functions, hyperparameter tuning.                   | `/week-3/training/`  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)             |
| 4    | 12 Mar    | Building shallow NNs with TensorFlow & PyTorch (dense layers).                | `/week-4/tf-pytorch/`  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)           |
| 5    | 19 Mar    | Evaluating shallow NNs: Metrics. Loading data (CSV, HDF5, images).            | `/week-5/evaluation/`  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)           |
| 6    | 26 Mar    | Data preprocessing (normalization, one-hot). Advanced shallow NNs.            | `/week-6/preprocessing/`  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)        |
| 7    | 02 Apr    | Academic recess (Easter). No class.                                           | -                                        |
| 8    | 09 Apr    | Continued: Preprocessing & advanced NNs in PyTorch/TensorFlow.                | `/week-8/advanced-nns/`  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)         |
| 9    | 16 Apr    | **Seminar 1**                                                                 | `/seminar-1/`  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)                   |
| 10   | 23 Apr    | CNNs: Intro, convolutions, pooling, fully connected layers.                   | `/week-10/cnn-intro/`  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)           |
| 11   | 30 Apr    | Training CNNs: Loss, optimizers, regularization (dropout, L1/L2), transfer learning. | `/week-11/cnn-training/`  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)    |
| 12   | 07 May    | CNN apps: Image classification, detection, segmentation. Data aug, visualization. | `/week-12/cnn-apps/`  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)         |
| 13   | 14 May    | RNNs intro: LSTM/GRU layers, info flow, training.                             | `/week-13/rnns/`  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)                |
| 14   | 21 May    | Encoder-Decoder: Machine translation, text generation. Training challenges.   | `/week-14/encoder-decoder/`  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)     |
| 15   | 28 May    | GANs intro: Generator vs. Discriminator, training.                            | `/week-15/gans/`  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)                |
| 16   | 04 Jun    | National Holiday (Corpus Christi). No class.                                  | -                                        |
| 17   | 11 Jun    | Reinforcement Learning: Agents, Markov processes, Q-Learning, SARSA.          | `/week-17/rl/`  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)                  |
| 18   | 18 Jun    | **Seminar 2**                                                                 | `/seminar-2/`  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)                   |  [ppl-ai-file-upload.s3.amazonaws](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/27709701/4adbb447-9791-40cd-b7a9-7fa61628bcb5/1-PROGRAM-CONTENT.pdf)
